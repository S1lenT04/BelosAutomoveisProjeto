namespace BelosAutomoveisProjeto
{
    partial class HomePage
    {
        ...
        private void InitializeComponent()
        {
            ...
            username = new Label();
            recuarDiaBtn = new Button();
            avancarDiaBtn = new Button();
            ...
            // downloadCsvBtn
            // 
            downloadCsvBtn.BackColor = Color.Transparent;
            downloadCsvBtn.FlatAppearance.BorderSize = 0;
            downloadCsvBtn.FlatAppearance.MouseDownBackColor = Color.Transparent;
            downloadCsvBtn.FlatAppearance.MouseOverBackColor = Color.Transparent;
            ...
            // reservaBtn
            // 
            reservaBtn.BackColor = Color.Transparent;
            reservaBtn.FlatAppearance.BorderSize = 0;
            reservaBtn.FlatAppearance.MouseDownBackColor = Color.Transparent;
            reservaBtn.FlatAppearance.MouseOverBackColor = Color.Transparent;
            ...
            // estadoBtn
            // 
            estadoBtn.BackColor = Color.Transparent;
            estadoBtn.FlatAppearance.BorderSize = 0;
            estadoBtn.FlatAppearance.MouseDownBackColor = Color.Transparent;
            estadoBtn.FlatAppearance.MouseOverBackColor = Color.Transparent;
            ...
            // addVeiculoBtn
            // 
            addVeiculoBtn.BackColor = Color.Transparent;
            addVeiculoBtn.FlatAppearance.BorderSize = 0;
            addVeiculoBtn.FlatAppearance.MouseDownBackColor = Color.Transparent;
            addVeiculoBtn.FlatAppearance.MouseOverBackColor = Color.Transparent;
            ...
            // emManutencaoBtn
            // 
            emManutencaoBtn.BackColor = Color.Transparent;
            emManutencaoBtn.FlatAppearance.BorderSize = 0;
            emManutencaoBtn.FlatAppearance.MouseDownBackColor = Color.Transparent;
            emManutencaoBtn.FlatAppearance.MouseOverBackColor = Color.Transparent;
            ...
            // recuarDiaBtn
            // 
            recuarDiaBtn.BackColor = Color.Transparent;
            recuarDiaBtn.FlatAppearance.BorderSize = 0;
            recuarDiaBtn.FlatAppearance.MouseDownBackColor = Color.Transparent;
            recuarDiaBtn.FlatAppearance.MouseOverBackColor = Color.Transparent;
            recuarDiaBtn.FlatStyle = FlatStyle.Flat;
            recuarDiaBtn.Font = new Font("Segoe UI", 15.75F, FontStyle.Bold, GraphicsUnit.Point);
            recuarDiaBtn.ForeColor = SystemColors.Control;
            recuarDiaBtn.Location = new Point(1459, 238);
            recuarDiaBtn.Name = "recuarDiaBtn";
            recuarDiaBtn.Size = new Size(40, 39);
            recuarDiaBtn.TabIndex = 26;
            recuarDiaBtn.UseVisualStyleBackColor = false;
            recuarDiaBtn.Click += button1_Click;
            // 
            // avancarDiaBtn
            // 
            avancarDiaBtn.BackColor = Color.Transparent;
            avancarDiaBtn.FlatAppearance.BorderSize = 0;
            avancarDiaBtn.FlatAppearance.MouseDownBackColor = Color.Transparent;
            avancarDiaBtn.FlatAppearance.MouseOverBackColor = Color.Transparent;
            avancarDiaBtn.FlatStyle = FlatStyle.Flat;
            avancarDiaBtn.Font = new Font("Segoe UI", 15.75F, FontStyle.Bold, GraphicsUnit.Point);
            avancarDiaBtn.ForeColor = SystemColors.Control;
            avancarDiaBtn.Location = new Point(1797, 238);
            avancarDiaBtn.Name = "avancarDiaBtn";
            avancarDiaBtn.Size = new Size(40, 39);
            avancarDiaBtn.TabIndex = 27;
            avancarDiaBtn.UseVisualStyleBackColor = false;
            avancarDiaBtn.Click += button2_Click;
            // 
            // faturacaoBtn
            // 
            ...
            precoFinalLabel.Location = new Point(1591, 246);
            ...
            ClientSize = new Size(1904, 994);
            Controls.Add(precoFinalLabel);
            Controls.Add(faturacaoBtn);
            Controls.Add(avancarDiaBtn);
            Controls.Add(recuarDiaBtn);
        ...
        private Button recuarDiaBtn;
        private Button avancarDiaBtn;
